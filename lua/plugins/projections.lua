	...
	config = function()
		require("projections").setup({
			workspaces = { -- Default workspaces to search for
				...
				"~/Workspace", -- dev is a workspace. default patterns is used (specified below)
			},
			patterns = { ".git", ".svn", ".hg", ".project", ".venv", "venv", "package.json", "Cargo.toml" }, -- Default patterns to use if none were specified. These are NOT regexps.
